...
export const ASSET_SERVICE = Symbol.for('atlas.asset-service');
export const ASSET_VARIANT_SERVICE = Symbol.for('atlas.asset-variant-service');
export const ASSET_UPLOAD_COORDINATOR = Symbol.for('atlas.asset-upload-coordinator');
