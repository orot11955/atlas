...
export class TypeOrmPublicationScheduleEffectRepository implements PublicationScheduleEffectRepositoryPort<EntityManager> {
  public async find(
    scheduleId: string,
    workspaceId: string,
    ...
    return Object.freeze({
      ...
      contentSiteId: String(row.content_site_id),
      ...
      target: readPublicationScheduleTarget({
        ...
        targetPublicationId:
          row.target_publication_id == null ? undefined : String(row.target_publication_id),
      }),
  ...
  public async insert(
    ...
    await transaction.query(
      ...
      [
        ...
        receipt.workspaceId,
        receipt.contentId,
        receipt.contentSiteId,
        receipt.siteId,
        target.action,
        target.action === 'publish' ? target.revisionId : null,
